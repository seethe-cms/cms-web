 ...
 */
let DeltaWorkflow = class DeltaWorkflow extends LitElement {
    render() {
        return html `
...
DeltaWorkflow.styles = css `
  ...
  `;
DeltaWorkflow = __decorate([
    customElement('delta-workflow')
], DeltaWorkflow);
export { DeltaWorkflow };
//# sourceMappingURL=delta-workflow.js.map